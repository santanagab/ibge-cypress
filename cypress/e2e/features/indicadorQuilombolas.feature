...
Funcionalidade: Visualizar o indicador Quilombolas por região
...
Cenário: Filtrar indicador Quilombolas região Nordeste
    Quando seleciono o tema "Quilombolas"
...
Cenário: Filtrar indicador Quilombolas estado Paraíba
    Quando seleciono o tema "Quilombolas"
...
Cenário: Filtrar indicador Quilombolas município João Pessoa
    Quando seleciono o tema "Quilombolas"
    E seleciono a região "João Pessoa (PB)" no filtro de localidade
    Então exibe a página "dados" da população quilombola do município de João Pessoa
